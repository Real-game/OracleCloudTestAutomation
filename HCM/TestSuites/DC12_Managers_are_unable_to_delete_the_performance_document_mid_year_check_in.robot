...
*** Variables ***
${json_path}    ./TestData/td_DC12_Managers_are_unable_to_delete_the_performance_document_mid_year_check_in.json
${csv_path}  ./CSV/td_DC12_Managers_are_unable_to_delete_the_performance_document_mid_year_check_in.csv

*** Test Cases ***
Scenario: Managers are unable to delete the performance document(mid year check in)
