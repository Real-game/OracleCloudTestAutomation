...
Documentation  Verify Termination with Quick Pay
...            Prerequisite: Need Fresh Terminated Employee details
...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC093_Verify_Termination_With_Quick_Pay.json
${csv_path}  ./CSV/td_PAY_TC093_Verify_Termination_With_Quick_Pay.csv
${common_json_path}  ./TestData/Payroll_common_test_data.json
${common_csv_path}  ./CSV/Payroll_common_test_data.csv
*** Test Cases ***

Scenario: Verify Termination with Quick Pay
