...
...            Reusable Data: Parent Action; Child Action; Overall Salary
...
Scenario: Verify Element Entry
    [Tags]  PayrollTestCase56897  ReadOnly
...
#    Select action Dropdown  ${data}[Parent Action2]  ${data}[Child Action2]
    Log  Step 8
    Verify overall salary amount in Element Entries table  ${data}[Overall Salary]
    Log  Step 9
