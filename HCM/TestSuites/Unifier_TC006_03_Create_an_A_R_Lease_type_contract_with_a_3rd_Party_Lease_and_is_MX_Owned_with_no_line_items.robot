...
Documentation  Create an A/R Lease type contract with a 3rd Party Lease and is MX Owned (with no line items)
...            Prerequisite: NA
...            Environment Specific Data:  Property Workspace Name;MX CRE File
...            Reusable Data:  Contract Name;Contract Type;Contract Rent Structure;Head Lease or Sublease;MX Owned or Leased;Status;Original Contract Start Date;Current Term Start Date;Current Term Expiry Date;Tenant Entity Type;Landlord Entity Type
...
*** Variables ***
${json_path}    ./TestData/td_TC006_03_Create_an_A_R_Lease_type_contract_with_a_3rd_Party_Lease_and_is_MX_Owned_with_no_line_items.json
${csv_path}  ./CSV/td_TC006_03_Create_an_A_R_Lease_type_contract_with_a_3rd_Party_Lease_and_is_MX_Owned_with_no_line_items.csv
*** Test Cases ***

Scenario: Create an A/R Lease type contract with a 3rd Party Lease and is MX Owned (with no line items)
    ...
    Select Head Lease or Sublease  ${data}[Head Lease or Sublease]
    Select MX Owned or Leased  ${data}[MX Owned or Leased]
    Select Status  ${data}[Status]
    Select Value from Advanced Search  Ref. Owned Property  ${data}[Ref Owned Property]
    Log  Step 4
