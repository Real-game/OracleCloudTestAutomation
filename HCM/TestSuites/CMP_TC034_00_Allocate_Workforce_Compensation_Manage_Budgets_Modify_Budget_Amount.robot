...
Documentation  Allocate Workforce Compensation - Manage Budgets - Modify Budget Amount
...
...            Reusable Data:  Budget Pool;Modify Reason;Modify Budget Amount;Distribution Option
...
*** Test Cases ***
Scenario: Allocate Workforce Compensation - Manage Budgets - Modify Budget Amount
    ...
    Adjust the budget  ${data}[Budget Pool]  ${data}[Modify Reason]  ${data}[Modify Budget Amount]
