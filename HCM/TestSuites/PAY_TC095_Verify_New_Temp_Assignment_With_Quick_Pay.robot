...
Documentation  Verify new Temp Assignment with Quick Pay
...            Prerequisite: HR-82
...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC095_Verify_New_Temp_Assignment_With_Quick_Pay.json
${csv_path}  ./CSV/td_PAY_TC095_Verify_New_Temp_Assignment_With_Quick_Pay.csv
*** Test Cases ***

Scenario: Verify new Temp Assignment with Quick Pay
