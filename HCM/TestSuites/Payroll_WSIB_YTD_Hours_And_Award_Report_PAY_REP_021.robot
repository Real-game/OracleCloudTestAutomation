...
Documentation  MX Payroll - WSIB YTD Hours and Award Report (PAY-REP-021)
...
*** Variables ***
${json_path}    ./TestData/td_Payroll_WSIB_YTD_Hours_And_Award_Report_PAY_REP_021.json
${csv_path}  ./CSV/td_Payroll_WSIB_YTD_Hours_And_Award_Report_PAY_REP_021.csv
${common_json_path}    ./TestData/Core_HR_common_test_data.json
${common_csv_path}  ./CSV/Core_HR_common_test_data.csv

*** Test Cases ***
Scenario: MX Payroll - WSIB YTD Hours and Award Report (PAY-REP-021)
    ...
    Sleep  2s
    Log  Step 17 - 24
    Select Pay Period for Report Run in WSIB YTD   ${data}[Pay Period]
    Log  Step 25
    select frame  xpath: //iframe[contains(@id,"generalObjectEditor")]
    Log  Step 26
