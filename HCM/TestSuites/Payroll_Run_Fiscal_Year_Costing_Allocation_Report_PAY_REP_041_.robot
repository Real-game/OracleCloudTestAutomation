...
Documentation  Run Fiscal Year Costing Allocation Report (PAY-REP-041)
...
*** Variables ***
${json_path}    ./TestData/Payroll_Run_Fiscal_Year_Costing_Allocation_Report_PAY-REP-041.json
${csv_path}  ./CSV/td_Payroll_Run_Fiscal_Year_Costing_Allocation_Report_PAY-REP-041.csv
${common_json_path}    ./TestData/Core_HR_common_test_data.json
${common_csv_path}  ./CSV/Core_HR_common_test_data.csv

*** Test Cases ***
Scenario: Run Fiscal Year Costing Allocation Report (PAY-REP-041)
    ...
    Sleep  2s
    Log  Step 17 - 24
    Select Pay Period for Report Run in PAY costing allocation  ${data}[Pay Period]
    Log  Step 25
    select frame  xpath: //iframe[contains(@id,"generalObjectEditor")]
    Log  Step 26
