...
Scenario: Remediation/restoration end date cannot be earlier than remediation/restoration start date in Owned property Line item "Environmental Condition".
    ...
    Validate Property Use Block  MX Owned  Yes  Future Description  Oct/23/2025  Transitional Area Comments
    ...
    Validate building demolitions block  Oct/23/2025  Demolition Comments
    Validate property disposed details block   FULL  Oct/23/2025  70000  2400  Disposition details  MPM Company
    ...
    ${today_date}=  commonkeywords.get current date mon dd yyyy
