...
Test Template  Verify Customer Site Record cannot be deleted
...
*** Test Cases ***
TC002.05-Verify Customer Site Record cannot be deleted with - ${Id} ${Login_User}
    [Tags]  CustomerIntegrationTestCase  ReadOnly

*** Keywords ***
Verify Customer Site Record cannot be deleted
