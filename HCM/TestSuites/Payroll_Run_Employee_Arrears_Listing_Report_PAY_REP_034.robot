...
Documentation  Run_Employee_Arrears_Listing_Report_PAY_REP_034
...
*** Variables ***
${json_path}    ./TestData/Payroll_Run_Employee_Arrears_Listing_Report_PAY_REP_034.json
${csv_path}  ./CSV/td_Payroll_Run_Employee_Arrears_Listing_Report_PAY_REP_034.csv
${common_json_path}    ./TestData/Core_HR_common_test_data.json
${common_csv_path}  ./CSV/Core_HR_common_test_data.csv

*** Test Cases ***
Scenario: Run_Employee_Arrears_Listing_Report_PAY_REP_034
    ...
    Sleep  2s
    Log  Step 17 - 24
    Select Pay Period for Report Run in Arrer_Listing_Report  ${data}[Pay Period]
    Log  Step 25
    select frame  xpath: //iframe[contains(@id,"generalObjectEditor")]
    Log  Step 26
