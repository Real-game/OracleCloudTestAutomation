...
Documentation  Verify Re-hire with Quick Pay
...            Prerequisite: HR-84 (Need Re-hire Employee details)
...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC092_Verify_Rehire_With_Quick_Pay.json
${csv_path}  ./CSV/td_PAY_TC092_Verify_Rehire_With_Quick_Pay.csv
*** Test Cases ***

Scenario: Verify Re-hire with Quick Pay
