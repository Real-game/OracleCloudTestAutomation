...
...            Reusable Data:  Plan(PFP_common_test_data.csv);Cycle(PFP_common_test_data.csv);Batch Process; Refresh Date; Refresh Option
...
*** Variables ***
${json_path}    ./TestData/td_CMP_TC001_11_Workforce_Compensation_Standard_Functionality_Run_Batch_Processes_Refresh_Workforce_Compensation_Data.json
${csv_path}  ./CSV/td_CMP_TC001_11_Workforce_Compensation_Standard_Functionality_Run_Batch_Processes_Refresh_Workforce_Compensation_Data.csv
...
Scenario: Workforce Compensation - Standard Functionality - Run Batch Processes - Start Workforce Compensation Cycle
    ...
    Log  Step 10
    Select Refresh Date  ${data}[Refresh Date]
    Log  Step 11
    Select Refresh Option  ${data}[Refresh Option]
    Log  Step 12
    Click Submit Button
