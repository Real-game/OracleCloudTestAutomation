...
Documentation  Verify Benefit changes with Quick Pay
...            Prerequisite: TC014
...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC094_Verify_Benefit_Changes_With_Quick_Pay.json
${csv_path}  ./CSV/td_PAY_TC094_Verify_Benefit_Changes_With_Quick_Pay.csv
*** Test Cases ***

Scenario: Verify Benefit changes with Quick Pay
