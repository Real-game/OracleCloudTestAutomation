...
*** Variables ***
${json_path}    ./TestData/Payroll_Run_Payroll_Register_Report_PAY-REP-038.json
${csv_path}  ./CSV/td_Payroll_Run_Payroll_Register_Report_PAY-REP-038.csv
...
#    Select Pay Period From and To Report Run  ${data}[Pay Period from]  ${data}[Pay Period to]
    Select Pay Period for Report Run in Payroll Register  ${data}[Pay Period]
    Log  Step 25
    select frame  xpath: //iframe[contains(@id,"generalObjectEditor")]
    Log  Step 26
