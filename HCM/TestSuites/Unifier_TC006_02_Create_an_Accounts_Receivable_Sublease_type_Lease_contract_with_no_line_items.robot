...
Documentation  Create an Accounts Receivable Sublease type Lease contract with no line items
...            Prerequisite: NA
...            Environment Specific Data:  Property Workspace Name;MX CRE File
...            Reusable Data:  Contract Name;Contract Type as Lease;Contract Rent Structure;Status;Original Contract Start Date;Current Term Start Date;Current Term Expiry Date;Tenant Entity Type;Landlord Entity Type
...
*** Variables ***
${json_path}    ./TestData/td_TC006_02_Create_an_Accounts_Receivable_Sublease_type_Lease_contract_with_no_line_items.json
${csv_path}  ./CSV/td_TC006_02_Create_an_Accounts_Receivable_Sublease_type_Lease_contract_with_no_line_items.csv
*** Test Cases ***

Scenario: Create an Accounts Receivable Sublease type Lease contract with no line items
