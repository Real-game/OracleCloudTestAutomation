...
Documentation  Run Payroll OMERS Year End Validation Report (PAY-REP-044)
...
*** Variables ***
${json_path}    ./TestData/Payroll_OMERS_Year_End_Validation_Report_PAY-REP-044.json
${csv_path}  ./CSV/td_Payroll_OMERS_Year_End_Validation_Report_PAY-REP-044.csv
${common_json_path}    ./TestData/Core_HR_common_test_data.json
${common_csv_path}  ./CSV/Core_HR_common_test_data.csv

*** Test Cases ***
Scenario: Run Payroll OMERS Year End Validation Report (PAY-REP-044)
