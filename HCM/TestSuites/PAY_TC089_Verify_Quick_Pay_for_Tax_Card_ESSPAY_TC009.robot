...
Documentation  Verify Quick Pay for Tax Card (ESSPAY_TC009)
...            Prerequisite: ESSPAY_TC009
...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC089_Verify_Quick_Pay_for_Tax_Card_ESSPAY_TC009.json
${csv_path}  ./CSV/td_PAY_TC089_Verify_Quick_Pay_for_Tax_Card_ESSPAY_TC009.csv
...
Scenario: Verify New Hire with Quick Pay
    ...
    Log  Step 11
    Click Tax Credit Information and check Additional Tax  ${data}[Additional Tax]
    Log  Step 12
