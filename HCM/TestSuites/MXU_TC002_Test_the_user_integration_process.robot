...
${hr_interface_xxmx_lrn_user_csv_column_name}  PERSON_NUMBER|USER_NAME|FIRST_NAME|LAST_NAME|EMAIL_ADDRESS|MEMBERSHIP_STATUS|PERSON_TYPE|PREFERRED_NAME|DEPARTMENT_CODE|DEPARTMENT_NAME|DIVISION_NAME|LOCATION_NAME|SUPERVISOR_NAME|SUPERVISOR_ID|HIRE_DATE|JOB_CODE|JOB_NAME|GRADE_NAME|POSITION_NAME|POSITION_CODE|BARGAINING_UNIT|HR_STATUS
