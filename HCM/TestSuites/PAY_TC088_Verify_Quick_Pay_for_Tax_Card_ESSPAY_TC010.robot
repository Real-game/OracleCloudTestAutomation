...
*** Variables ***
${json_path}    ./TestData/td_PAY_TC088_Verify_Quick_Pay_for_Tax_Card_ESSPAY_TC010.json
${csv_path}  ./CSV/td_PAY_TC088_Verify_Quick_Pay_for_Tax_Card_ESSPAY_TC010.csv
