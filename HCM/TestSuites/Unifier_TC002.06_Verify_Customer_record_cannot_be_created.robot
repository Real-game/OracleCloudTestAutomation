...
Test Template  Verify Customer Record cannot be created
...
*** Test Cases ***
TC002.06-Verify Customer Record cannot be created with - ${Id} ${Login_User}
    [Tags]  CustomerIntegrationTestCase  ReadOnly

*** Keywords ***
Verify Customer Record cannot be created
