...
${business_origin_field_btn}     xpath: (//*[@id="shellselect"]//span)[1]
#(//span[text()='Select Business Process Origin']/parent::b/parent::label/parent::div/parent::oj-label/following-sibling::oj-select-single//a)[1]
