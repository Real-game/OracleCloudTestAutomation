...
${property_tax_invoice_link}   xpath: //td[@data-index='report_name']//div/mark[text()='Tax']
...
${utility_bills_report_link}   xpath: //td[@data-index='report_name']//div[text()='Utility ']/mark[text()='Bills']
