...
${customers_site_table_frame}   xpath: (//iframe[contains(@src,'/studio')])[1]
${first_customer_site_record}   xpath: (//tr[@data-group-id='columnGroup_0'][contains(@id,'12grid')])[1]
${customer_site_actions_drop_down}       xpath: //span[text()='Actions']
${terminate_customers_site_record_link}    xpath: //a[text()='Terminate Record...']
${alert_customers_site_message_text}       xpath: //span[text()='You do not have permission to perform this action.']
${ok_button_customer_site_record}     xpath: //span[text()='Alert']//ancestor::oj-dialog//span[text()='OK']

${create_customer_site_button}    xpath: xpath: //span[text()='Create']/parent::span/parent::span/parent::div/parent::button[@tabindex='-1']/parent::oj-button[contains(@class,'default')]
...
${address_2_input}         xpath: //label[text()='Address 2']//ancestor::oj-label/parent::div/parent::div/following-sibling::div//div[@role='textbox']

${search_customer_site_icon}     xpath: //button//span[contains(@class,'search')][@slot='startIcon']
${search_customer_site_apply}    xpath: (//span[text()='Apply'])[1]
${site_id_search_input}          xpath: //label[text()='Site ID']/parent::div/ancestor::search-string-field//input[@aria-label='Site ID']