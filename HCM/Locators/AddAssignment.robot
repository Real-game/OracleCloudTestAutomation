...
${assignment_start_date}  xpath://label[text()="When does the assignment start?"]/following::input[1]
...
${assignment_way}  xpath://label[text()="What's the way to add the assignment?"]/following::input[2]
${assignment_reason_dropdown}  xpath:(//a[@class='xdv'])[2]
