...
...            Reusable Data: Move to State;Move to Phase;Are you at least 18 years of age?;Are you eligible to work in Canada?
...
*** Variables ***
${json_path}    ./TestData/td_BP011B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP011B.csv
${prerequisites_json_path}  ./TestData/td_BP001B.json  #If we want to run BP011B seperately - Update BP001B Json
${prerequisites_json_path2}  ./TestData/td_BP017B.json  #If we want to run BP011B seperately - Update BP017B Json
