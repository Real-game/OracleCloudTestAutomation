...
*** Variables ***
${json_path}    ./TestData/td_BP035B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP035B.csv
${prerequisites_json_path}  ./TestData/td_BP001B.json  #If we want to run BP035B seperately - Update BP001B Json
${prerequisites_json_path2}  ./TestData/td_BP017B.json  #If we want to run BP035B seperately - Update BP017B Json
