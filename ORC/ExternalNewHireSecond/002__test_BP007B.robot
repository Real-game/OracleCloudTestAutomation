...
*** Variables ***
${json_path}    ./TestData/td_BP007B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP007B.csv
${prerequisites_json_path}  ./TestData/td_BP001B.json  #If we want to run BP007B seperately - Update BP001B Json
