...
*** Variables ***
${json_path}    ./TestData/td_BP083B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP083B.csv
${prerequisites_json_path}  ./TestData/td_BP017B.json  #If we want to run BP042B seperately - Update BP017B Json
