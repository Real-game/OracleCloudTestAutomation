...
*** Variables ***
${json_path}    ./TestData/td_BP021B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP021B.csv
${prerequisites_json_path}  ./TestData/td_BP001B.json  #If we want to run BP021B seperately - Update BP001B Json
