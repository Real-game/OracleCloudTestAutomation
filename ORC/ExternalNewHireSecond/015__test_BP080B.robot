...
*** Variables ***
${json_path}    ./TestData/td_BP080B.json
${csv_path}  ./ExternalNewHireSecondCSV/td_BP080B.csv
${prerequisites_json_path}  ./TestData/td_BP017B.json  #If we want to run BP080B seperately - Update BP017B Json
