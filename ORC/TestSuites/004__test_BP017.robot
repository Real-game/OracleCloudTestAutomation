...
*** Variables ***
${json_path}    ./TestData/td_BP017.json
${csv_path}  ./CSV/td_BP017.csv
${prerequisites_json_path}  ./TestData/td_BP001.json  #If we want to run BP017 seperately - Update BP001 Json
