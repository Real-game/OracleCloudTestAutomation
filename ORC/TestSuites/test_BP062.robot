...
*** Variables ***
${json_path}    ./TestData/td_BP062.json
${csv_path}  ./CSV/td_BP062.csv
...
Scenario: Internal Job Application Flow
    ...
    Search for a pending worker   ${data}[Internal Employee Name]
    ...
    Login Using  ${data}[Assignee Journeys Specialist User]
    click on homepage
    Go to my client group Journeys
    Verify the reassigned task in My Tasks   ${reassigned_task_name}   ${data}[Internal Employee Name]
    Sleep  4s
    Assigned Journeys Logout
