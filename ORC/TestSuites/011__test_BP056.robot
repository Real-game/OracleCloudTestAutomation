...
*** Variables ***
${json_path}    ./TestData/td_BP056.json
${csv_path}  ./CSV/td_BP056.csv
${prerequisites_json_path}  ./TestData/td_BP001.json  #If we want to run BP056 seperately - Update BP001 Json
${prerequisites_json_path2}  ./TestData/td_BP017.json  #If we want to run BP056 seperately - Update BP017 Json
