...
*** Variables ***
${json_path}    ./TestData/td_BP021.json
${csv_path}  ./CSV/td_BP021.csv
${prerequisites_json_path}  ./TestData/td_BP001.json  #If we want to run BP021 seperately - Update BP001 Json
