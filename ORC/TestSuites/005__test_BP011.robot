...
*** Variables ***
${json_path}    ./TestData/td_BP011.json
${csv_path}  ./CSV/td_BP011.csv
${prerequisites_json_path}  ./TestData/td_BP001.json  #If we want to run BP011 seperately - Update BP001 Json
${prerequisites_json_path2}  ./TestData/td_BP017.json  #If we want to run BP011 seperately - Update BP017 Json
