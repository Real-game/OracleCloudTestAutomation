...
${workLocations_expand}  xpath://button[@data-filter-name="Locations"]
...
${esh_accept_btn}  xpath://span[text()="Accept"]
...
${month_dropdown}  xpath: //span[text()='Month']/following::a[1]
${month_input_select}  xpath: //ul/li/div//span//span
${day_dropdown}  xpath: //span[text()='Day']/following::a[1]
${year_input_value}  xpath: //span[text()='Year']/following::input[1]
...
${done_button_select}  xpath: //button[@data-qa="addPiiDialogButton"]//span[text()="Done"]
${gender_dropdown}  xpath: (//*[@aria-label="Gender"]//a)[1]
${gender_value_select}  xpath: //ul/li/div//span//span
...
${identifier_country_dropdown}  xpath: (//*[@aria-label="Country"]//child::a)[1]
