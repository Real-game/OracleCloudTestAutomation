...
${cc_dropdown}  xpath://oj-select-single[@aria-label="Phone Number Country code"]
...
${country_dropdown}  xpath://oj-select-single[@name="country"]/div/span/a
...
${province_input}    xpath://oj-select-single[@aria-label="Province"]
${province_search}    xpath:(//input[@aria-label="Province"])[1]
${postal_code_input}    xpath: //oj-select-single[@aria-label='Postal Code']
${postal_code_input_value}    xpath: //span[text()='Postal Code']//following::input[contains(@id,"oj-searchselect-filter-single-select")][1]
${city_input}  xpath: //*[@name="city"]
${city_input1}  xpath://span[text()='City']//following::input[contains(@id,"oj-searchselect-filter-single-select")][1]
...
${upload}  xpath://label[text()="Upload Resume"]
...
${sourcetype_dropdown}  xpath:(//*[@aria-label="Please select one of the Source type:"]//span/a)[1]

${workincanada_dropdown}  xpath:(//oj-select-single[@aria-label="Are you legally entitled to work in Canada?"]//span/a)[1]
...
${criminaloffence_dropdown}  xpath:(//*[@aria-label="Do you have a conviction for a criminal offence for which a pardon has not been granted?"]//span/a)[1]

${familymember_dropdown}  xpath:(//*[@aria-label="Are you a Family Member of a current Metrolinx Employee? A Family Member is defined according to our Nepotism policy as any of the following: an individual’s Parent, Parent-in-law, Step-parent, Child, Child-in-law, Stepchild, Spouse, Sibling, Sibling-in-law, Half-sibling, Grandparent, Grandchild, Aunt, Uncle, Niece, Nephew or First Cousin."]//span/a)[1]

${previously_employee}   xpath:(//*[@aria-label="Were you previously employed by Metrolinx?"]//span/a)[1]
...
${previouslyemployed_dropdown}  xpath: (//*[@aria-label="Were you previously employed by Metrolinx?"]//span/a)[1]
...
${external_error}  xpath: //div[contains(@class,'error')]
