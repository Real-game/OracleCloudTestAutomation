...
*** Variables ***
${json_path}    ./TestData/td_BP056_rehire.json
${csv_path}  ./RehireCSV/td_BP056_rehire.csv
${prerequisites_json_path}  ./TestData/td_BP001_rehire.json  #If we want to run this case seperately - Update td_BP001_rehire Json
${prerequisites_json_path2}  ./TestData/td_Change_Mail_for_Candidate.json  #If we want to run this case seperately - Update td_Change_Mail_for_Candidate Jsonn
