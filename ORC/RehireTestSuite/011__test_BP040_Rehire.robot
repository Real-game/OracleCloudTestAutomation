...
*** Variables ***
${json_path}    ./TestData/td_BP040_rehire.json
${csv_path}  ./RehireCSV/td_BP040_rehire.csv
${prerequisites_json_path}  ./TestData/td_BP001_rehire.json  #If we want to run this case seperately - Update td_BP001_rehire Json
${prerequisites_json_path2}  ./TestData/td_BP017_rehire.json  #If we want to run this case seperately - Update td_BP017_rehire Json
