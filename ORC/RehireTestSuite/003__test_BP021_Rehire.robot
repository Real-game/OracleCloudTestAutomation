...
*** Variables ***
${json_path}    ./TestData/td_BP021_rehire.json
${csv_path}  ./RehireCSV/td_BP021_rehire.csv
${prerequisites_json_path}  ./TestData/td_BP001_rehire.json  #If we want to run BP021 seperately - Update BP001 Json
