...
*** Variables ***
${json_path}    ./TestData/td_BP007_rehire.json
${csv_path}  ./RehireCSV/td_BP007_rehire.csv
${prerequisites_json_path}  ./TestData/td_BP001_rehire.json  #If we want to run BP007 seperately - Update BP001 Json
