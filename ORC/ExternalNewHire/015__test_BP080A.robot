...
*** Variables ***
${json_path}    ./TestData/td_BP080A.json
${csv_path}  ./ExternalNewHireCSV/td_BP080A.csv
${prerequisites_json_path}  ./TestData/td_BP017A.json  #If we want to run BP080A seperately - Update BP017A Json
