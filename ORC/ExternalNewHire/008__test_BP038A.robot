...
*** Variables ***
${json_path}    ./TestData/td_BP038A.json
${csv_path}  ./ExternalNewHireCSV/td_BP038A.csv
${prerequisites_json_path}  ./TestData/td_BP001A.json  #If we want to run BP038A seperately - Update BP001A Json
${prerequisites_json_path2}  ./TestData/td_BP017A.json  #If we want to run BP038A seperately - Update BP017A Json
