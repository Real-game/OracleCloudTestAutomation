...
*** Variables ***
${json_path}    ./TestData/td_BP017A.json
${csv_path}  ./ExternalNewHireCSV/td_BP017A.csv
${prerequisites_json_path}  ./TestData/td_BP001A.json  #If we want to run BP017A seperately - Update BP001A Json
