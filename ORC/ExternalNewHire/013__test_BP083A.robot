...
*** Variables ***
${json_path}    ./TestData/td_BP083A.json
${csv_path}  ./ExternalNewHireCSV/td_BP083A.csv
${prerequisites_json_path}  ./TestData/td_BP017A.json  #If we want to run BP042A seperately - Update BP017A Json
